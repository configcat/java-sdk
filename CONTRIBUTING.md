# Contributing to the ConfigCat SDK for Java
...
The ConfigCat SDK team monitors the [issue tracker](https://github.com/configcat/java-sdk/issues) in the SDK repository. Bug reports and feature requests specific to this SDK should be filed in this issue tracker. The team will respond to all newly filed issues.
...
This ConfigCat SDK builds with [Gradle](https://gradle.org/) and should be built against Java 8.
